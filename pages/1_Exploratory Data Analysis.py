...
dataset_options = ["gym_details", "inventory_details"]
selected_dataset = st.radio("Select Dataset", dataset_options)

if st.button("Run EDA") or st.session_state.data_loaded:
